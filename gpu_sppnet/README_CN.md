...
| 参数 |  GPU |
| -------------------------- | ------------------------------------------------------------ |
| 资源 | GeForce RTX 3090, Intel(R) Xeon(R) Gold 6226R CPU @ 2.90GHz; Memory：256G |
| 上传日期 | 2021-11-27 |
| MindSpore版本 |1.5.0 |
| 数据集 | ImageNet2012 |
...
| 总时间 |  18.5小时 |
| 微调检查点 |  594M (.ckpt文件) |
| 脚本 |  [SPPNet脚本](https://gitee.com/mindspore/models/tree/master/research/cv/SPPNet) |
...
| MindSpore版本 |  1.5.0 |
| 数据集 |  ImageNet2012 |
| 训练参数 |  epoch=150, step_per_epoch=5004, batch_size=256, lr=0.001 |
| 优化器 | 动量                                                         |
| 损失函数 |  Softmax交叉熵 |
| 输出 |  概率 |
| 损失 | 1.57 |
...
| MindSpore版本 |  1.5.0 |
| 数据集 |  ImageNet2012 |
| 训练参数 |  epoch=150, step_per_epoch=10009, batch_size=128, lr=0.001 |
| 优化器 |  动量 |
| 损失函数 | Softmax交叉熵 |
| 输出 |  概率 |
| 损失 |1.88 |
